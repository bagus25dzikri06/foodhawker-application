...
import com.sinaukoding.foodhawker.model.app.Checks;
import com.sinaukoding.foodhawker.model.enums.TipeUpload;
import com.sinaukoding.foodhawker.model.response.BaseResponse;
import com.sinaukoding.foodhawker.service.app.FileService;
import com.sinaukoding.foodhawker.util.DateUtil;
    ...
    private String storeFile(MultipartFile file, TipeUpload tipeUpload) {
        ...
        try {
            if (!contentType.equals("image/jpg")
                ...
                throw new RuntimeException("Sorry, your file content type doesn't support");
            }
